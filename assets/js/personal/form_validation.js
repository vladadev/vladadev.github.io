;(function () {
  ...
  function validateEmail() {
    ...
    if (contactEmail.value === '') {
      errorParagraph.innerHTML =
        'Write down your e-mail address so i could reply to you!'
      return false
    }
    ...
    if (!testRegex) {
      errorParagraph.innerHTML =
        'Wrong e-mail format. E.g. "example1@domain.com"!'
      return false
    }
  ...
  function validateTitle() {
    ...
    if (contactTitle.value === '') {
      errorParagraph.innerHTML =
        'You skipped title. Write simple and short one!'
      return false
    }
    ...
    if (!testRegex) {
      errorParagraph.innerHTML =
        'Please capitalize your first letter, just to make it look more formal!'
      return false
    }
  ...
  function validateMessage() {
    ...
    if (contactMessage.value === '') {
      errorParagraph.innerHTML =
        'Come on, tell me at least something! What is on your mind?'
      return false
    }
    ...
    if (contactMessage.value.length < 10) {
      errorParagraph.innerHTML =
        'Tell me a little bit more... ,at least 10 characters!'
      return false
    }
